    ...
    <div>
        ...
        <div className="glass-card p-3 md:p-4 mb-6 opacity-0 animate-fade-in stagger-1">
          ...
          <div className="flex gap-2 md:gap-3 overflow-x-auto pb-2">
            {birthdayMembers.map((member) => (
              ...
              >
                <div
                  className="w-10 h-10 md:w-12 md:h-12 rounded-full overflow-hidden bg-surface-hover flex items-center justify-center cursor-pointer hover:ring-2 hover:ring-yellow-400/50 transition-all"
                ...
                >
                  {member.photo_url ? (
                    ...
                    <User className="w-5 h-5 md:w-6 md:h-6 text-subtle" />
                  )}
                </div>
                <div className="text-center">
                  <p className="text-strong text-[10px] md:text-xs font-medium truncate max-w-[60px] md:max-w-[70px]">
                    {member.name.split(" ")[0]}
                  </p>
      ...
      <div className="glass-card p-3 md:p-4 mb-6 opacity-0 animate-fade-in stagger-2">
        <div className="flex items-center gap-4 md:gap-6">
          <div>
            <p className="text-subtle text-[10px] md:text-xs">Total</p>
          ...
          <div>
            <p className="text-subtle text-[10px] md:text-xs">Ativos</p>
          ...
          <div className="w-px h-8 bg-border" />
          <div>
            <p className="text-subtle text-[10px] md:text-xs">Visitantes</p>
              ...
              {members.map((member) => (
                ...
                >
                  ...
                  <div className="flex items-start gap-3 mb-3">
                    <div
                      className="w-12 h-12 rounded-full overflow-hidden bg-surface-hover flex items-center justify-center flex-shrink-0 cursor-pointer hover:ring-2 hover:ring-blue-400/50 transition-all"
                      onClick={() => member.photo_url && openPhotoViewer(member.photo_url, member.name)}
                    >
                      {member.photo_url ? (
                        <Image
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {member.ministry && (
                        <p className="text-subtle text-xs">{member.ministry}</p>
                      )}
                    </div>
                    <span
        ...
        >
          <div className="relative max-w-md max-h-[80vh] w-full">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-white font-semibold">{photoViewerName}</h3>
              <button
                onClick={closePhotoViewer}
